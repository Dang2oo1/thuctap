                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            <h1 class="text-white">Cửa hàng đồ ăn</h1>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <form method="post" role="form">
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" required name="customer_name" placeholder="Họ và tên" type="text">
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" required name="customer_phoneno" placeholder="Số điện thoạt" type="text">
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" required name="customer_password" placeholder="Mật khẩu" type="password">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="text-left">
                                        <button type="submit" name="addCustomer" class="btn btn-primary my-4">Tạo tài khoản</button>
