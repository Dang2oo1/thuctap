...
if (isset($_POST['ChangeProfile'])) {
    ...
    $Qry = "UPDATE rpos_staff SET staff_name =?, staff_email =?, old_password =?, new_password =?, confirm_password=? WHERE staff_id =?";
    $postStmt = $mysqli->prepare($Qry);
    //bind paramaters
    $rc = $postStmt->bind_param('sssssi', $staff_name, $staff_email,$old_password,$new_password,$confirm_password, $staff_id);
    $postStmt->execute();
                ...
                <div class="container-fluid d-flex align-items-center">
                    <div class="row">
                        <div class="col-lg-7 col-md-10">
                            <h1 class="display-2 text-white">Chào <?php echo $staff->staff_name; ?></h1>
                            <p class="text-white mt-0 mb-5">Đây là trang hồ sơ của bạn. Bạn có thể tùy chỉnh hồ sơ của mình theo ý muốn Và cũng có thể thay đổi mật khẩu</p>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="pl-lg-4">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="submit" id="input-email" name="ChangeProfile" class="btn btn-success form-control-alternative" value="Thay đổi">
                                                        </div>
                                                        </div>
                                                    </div>
                                                    </div>
                                        ...
                                        <div class="pl-lg-4">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="input-email">Xác nhận mật khẩu mới</label>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="submit" id="input-email" name="changePassword" class="btn btn-success form-control-alternative" value="Đổi mật khẩu">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
