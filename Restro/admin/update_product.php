...
if (isset($_POST['UpdateProduct'])) {
  ...
  if (empty($_POST["prod_code"]) || empty($_POST["prod_name"]) || empty($_POST['prod_desc']) || empty($_POST['prod_price'])) {
    ...
    if ($postStmt) {
      $success = "Đã sửa thành công" && header("refresh:1; url=products.php");
    } else {
      $err = "Lỗi, Hãy thử lại sau";
    }
  }
}
          ...
          <div class="col">
            <div class="card shadow">
              <div class="card-header border-0">
                <h3>Vui lòng điền vào tất cả các trường</h3>
              </div>
              <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                    <div class="col-md-6">
                      <input type="submit" name="UpdateProduct" value="Cập nhật sản phẩm" class="btn btn-success" value="">
                    </div>
                  </div>
                </form>
              </div>
