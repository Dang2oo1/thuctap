...
if (isset($_POST['login'])) {
  ...
  $admin_password = sha1(md5($_POST['admin_password'])); //mã hóa kép để tăng tính bảo mật
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white">Quản lý cửa hàng ( Admin )</h1>
            </div>
          </div>
        </div>
      </div>
              ...
              <form method="post" role="form">
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" required name="admin_password" placeholder="Mật khẩu" type="password">
                  </div>
                </div>
