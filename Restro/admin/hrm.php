        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <a href="add_staff.php" class="btn btn-outline-success"><i class="fas fa-user-plus"></i>Thêm mới nhân viên</a>
            </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a onclick="return confirm('Bạn chắc chắn muốn xóa ?')" href="hrm.php?delete=<?php echo $staff->staff_id; ?>">
